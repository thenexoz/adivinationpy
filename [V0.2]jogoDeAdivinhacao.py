#coding: utf-8
"""
    Jogo de Adivinhação Numérica - Versão 0.2
...
#Loop While para a repetição do jogo, enquanto nao acertar.
while (errou == False):
